...
export default async function Home() {
  ...
  return (
    <div>
      <h1 className="text-7xl font-extrabold">Hello I&apos;m <span className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent">Patricia</span>!</h1>
    <p className="mt-3 text-x1 text-gray-600">Hello everyone! Check out my projects!</p>
